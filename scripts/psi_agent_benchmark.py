...
DEFAULT_CONFIG = BENCHMARK_ROOT / "configs" / "tau2_subsets.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--model", default=os.environ.get("PSI_AI_MODEL", "deepseek-chat"))
    run_parser.add_argument(
        "--base-url",
        default=os.environ.get("PSI_AI_BASE_URL", "https://api.deepseek.com/v1"),
    )
    run_parser.add_argument("--api-key-file", default=str(DEFAULT_TAU2_ROOT / "api"))
    run_parser.add_argument("--user-llm", default=os.environ.get("TAU2_USER_LLM", "deepseek/deepseek-chat"))
